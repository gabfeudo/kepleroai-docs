...
│   │   ├── best-practice-prompt.mdx — Best practice prompt: linee guida avanzate, differenze chatbot/voice (no link nel voice), consolidamento info sensibili, no tabelle markdown, esempi
