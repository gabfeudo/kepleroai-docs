...
<CardGroup cols={2}>
  ...
  <Card title="Centralino assente" icon="mobile" href="#centralino-assente">
...
<AccordionGroup>
  <Accordion title="Caratteristiche tecniche">
    | Caratteristica | Valore | | --- | --- | | Numero chiamante | ✅ Preservato
    | | Trasferimento agli interni | ✅ Sì | | Centralino richiesto | ✅ Sì | |
    Tipo di deviazione | A livello di provider (centrale) |
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="Caratteristiche tecniche">
    | Caratteristica | Valore | | --- | --- | | Numero chiamante | ❌ Perso | |
    Trasferimento agli interni | ❌ No | | Centralino richiesto | ✅ Sì | | Tipo
    di deviazione | Trasferimento tradizionale dal centralino |
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="Caratteristiche tecniche">
    | Caratteristica | Valore | | --- | --- | | Numero chiamante | ✅ Preservato
    | | Trasferimento agli interni | ✅ Sì (verso numeri esterni) | | Centralino
    richiesto | ❌ No | | Setup | Nessuna configurazione aggiuntiva |
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="Caratteristiche tecniche">
    | Caratteristica | Valore | | --- | --- | | Numero chiamante | ❌ Perso | |
    Trasferimento agli interni | ✅ Sì (verso numeri esterni) | | Centralino
    richiesto | ❌ No | | Gestione inoltro | A carico dell'operatore telefonico
    del cliente |
  </Accordion>
</AccordionGroup>
